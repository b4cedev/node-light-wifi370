...
(function () {
    ...
    var defaults = {
        autoConnect: true,
        autoReconnect: 3, // integer, 0 for off
        host: "192.168.10.81",
        port: 5577
    };
...
//console.log('Driver#connect():', {status: status});

                        return driver._socket;
                    }, function (error){
...
//console.log('Driver#connect(): Connecting...');
        ...
        reconnect: function (){
            (this._reconnectTries === undefined) && (this._reconnectTries = Driver.defaults.autoReconnect);
...
console.log('Driver#onSocketEnd(): Disconnected')
                return;
            }
console.log('Driver#onSocketEnd: Unexpected socket disconnection');
